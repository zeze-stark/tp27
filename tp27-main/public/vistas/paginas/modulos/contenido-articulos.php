...
if(isset($rutas[1])){
																															//Busca coincidencia en la columna ruta_articulos con lo que viene en $ruta[1]
...
/*--=====================================
FUNCION PARA LIMITAR UN foreach
======================================-->*/
				...
				<div class="container">
					...
					<input type="submit" class="btn btn-dark btn-lg btn-block" value="Enviar">
						...
						<?php
							...
							/* valida si enviar no es vacio, luego elimina el historial del formulario para no reenviar cada vez que actualice la pagina */ 
